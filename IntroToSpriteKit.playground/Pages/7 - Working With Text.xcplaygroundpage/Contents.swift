...
let yankees = SKLabelNode(fontNamed: "Baseball Team")
yankees.fontSize = 36
yankees.fontColor = .white
yankees.text = "Yankees"
yankees.position = CGPoint(x: scene.size.width / 4 * 3, y: 0)
yankees.physicsBody = SKPhysicsbody(rectangleOfSize: 30)
scene.addChild(yankees)
/*:
